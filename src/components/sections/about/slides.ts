 ...
 * Cada string es un bloque; se pintan de gris a negro con el scroll.
 */
export const mainPhrase: string[] = [
  "Great founders changing the world deserve a presence as powerful as what they're building. Most founders we work with are building something significant but their website doesn't show it yet.",
